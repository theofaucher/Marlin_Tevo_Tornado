...
#define STRING_CONFIG_H_AUTHOR "(Théo Faucher, Marlin 2.0.9.3)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 77.8, 77.8, 403.4, 444.4 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -12, -2.7 }
